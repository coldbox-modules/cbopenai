component accessors="true" singleton {
    ...
    function getModel( required string model ) {
        return sendRequest(
            endpoint = "https://api.openai.com/v1/models/#arguments.model#",
            HTTPMethod = "GET"
        );
    }
    ...
    private function sendRequest(
        ...
        throw( type="MissingModuleSetting", message="You must specify an 'cbopenai.apiKey' in your ColdBox.cfc module settings." );
    }
